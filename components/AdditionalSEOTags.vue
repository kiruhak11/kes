    ...
    category: [
      {
        name: "keywords",
        content:
          "категория котельного оборудования, котлы, котельные, теплообменники, водогрейные котлы, паровые котлы, модульные котельные, дымососы, вентиляторы, КотлоЭнергоСнаб",
      },
    ],
    product: [
      {
