<template>
  <div class="test-files-container">
    ...
    <div class="test-section" v-scroll-reveal="'fade-in-up'">
      <h2 v-scroll-reveal="'slide-in-left'">
        1. Проверка файлов в папке uploads
      </h2>
      <button
        @click="testFiles"
        :disabled="loading"
    ...
    <div class="test-section" v-scroll-reveal="'fade-in-up'">
      <h2 v-scroll-reveal="'slide-in-right'">
        2. Исправление путей в базе данных
      </h2>
      <button
        @click="fixPaths"
    ...
    <div class="test-section" v-scroll-reveal="'fade-in-up'">
      ...
      <div v-if="uploadResult" class="result" v-scroll-reveal="'fade-in-up'">
        ...
        >
          ...
          <button
            @click="testImageAccess(uploadResult.path)"
            v-scroll-reveal="'zoom-in'"
          >
    ...
    <div class="test-section" v-scroll-reveal="'fade-in-up'">
      ...
      <div v-if="filesResult && filesResult.files">
        ...
        >
          ...
          />
          <button
            @click="testImageAccess(file.path)"
            v-scroll-reveal="'zoom-in'"
          >
            Проверить доступ
          </button>
...
// SEO Meta Tags
useHead({
  title: "Тестирование файлов — КотлоЭнергоСнаб",
  meta: [
    {
      name: "description",
      content:
        "Страница тестирования файлов и изображений на сайте КотлоЭнергоСнаб. Проверка загрузки и отображения файлов.",
    },
    {
      name: "keywords",
      content:
        "КотлоЭнергоСнаб, тестирование файлов, загрузка изображений, проверка файлов, Барнаул",
    },
    { name: "author", content: "КотлоЭнергоСнаб" },
    { property: "og:site_name", content: "КотлоЭнергоСнаб" },
    { property: "og:title", content: "Тестирование файлов — КотлоЭнергоСнаб" },
    {
    ...
    { property: "og:url", content: "https://kes-sib.ru/test-files" },
    { property: "og:image", content: "/images/hero1.jpg" },
    { name: "twitter:card", content: "summary_large_image" },
    { name: "twitter:title", content: "Тестирование файлов — КотлоЭнергоСнаб" },
    {
  ...
  link: [
    ...
    { rel: "canonical", href: "https://kes-sib.ru/test-files" },
  ],
  script: [
    {
