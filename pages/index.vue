...
useHead({
  ...
  meta: [
    {
      name: 'description',
      content: 'Котельный завод КЭС в Барнауле - проектирование, производство, монтаж и пуско-наладка котельного оборудования. Водогрейные и паровые котлы, модульные котельные установки. Работаем по всей России.'
    },
    {
      name: 'keywords',
      content: 'котельный завод, котельное оборудование, котлы, модульные котельные, водогрейные котлы, паровые котлы, производство котлов, монтаж котельных, пуско-наладка, Барнаул, Алтайский край'
    },
    {
      name: 'author',
      content: 'Котельный завод КЭС'
    },
    {
      property: 'og:title',
      content: 'Котельный завод КЭС - Производство котельного оборудования в Барнауле'
    },
    {
      property: 'og:description',
      content: 'Проектирование, производство, монтаж и пуско-наладка котельного оборудования. Водогрейные и паровые котлы, модульные котельные установки.'
    },
    {
      property: 'og:type',
      content: 'website'
    ...
    {
      name: 'twitter:title',
      content: 'Котельный завод КЭС - Производство котельного оборудования'
    },
    {
      name: 'twitter:description',
      content: 'Проектирование, производство, монтаж и пуско-наладка котельного оборудования в Барнауле'
    },
    {
      name: 'robots',
